 ...
 */ import { CountriesListUrl } from "../constants/urls";
...
export default function Countries() {
  ...
  */
  ...
  const handleAddNew = () => {
    ...
    axios
      .post(
        "http://90.153.255.50/socialmediafamous/public/api/admin/countries/create",
        data,
        { headers }
      )
      .then((response) => {
  ...
  return (
    <Page title={t("description.CountriesPageTitle")}>
      <Container>
        <Stack
          direction="row"
          alignItems="center"
        ...
        >
          <Typography variant="h4" gutterBottom>
            {t("description.CountriesPageTitle")}
          </Typography>
          {roles.includes(10) && (
            <Button variant="contained" onClick={handleClickOpenNewCountry}>
              {t("description.CountriesPageNewButton")}
            </Button>
          )}
        </Stack>
        <Dialog
        ...
        >
          <DialogTitle>{t("description.CountriesPageNewButton")}</DialogTitle>
        ...
        <Card>
          <UserListToolbar
            placeHolder={t("description.CountriesPageSearchPlaceholder")}
